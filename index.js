...
const prefix = '.'
client.on('ready', () => {
  client.user.setGame('We Are Server','https://www.twitch.tv/peery13');
  ...
  client.on('message', message => {
    const prefix = '.'	
        ...
        if (msg.content === 'الوان') {
          if (msg.channel.id !== "497737772094717984") return;
    ...
    if (message.channel.id !== "497737772094717984") return;
